...
const features = [
  {
    ...
    description:
      "Tasky transforms your prompts into tasks instantly. Just tell Tasky what needs to be done, and watch your to-do list build itself intelligently.",
  ...
  },
  {
    ...
    description:
      "Let Tasky handle your schedule. It automatically places tasks into your Google Calendar — perfectly timed, with zero effort from you.",
  ...
  },
  {
    ...
    description:
      "Tasky scans your inbox, summarizes long emails, and extracts action items so you can focus on what matters most.",
...
export default function Features() {
  return (
    <section className="relative py-24 px-6 bg-gradient-to-br from-indigo-50 via-white to-purple-50">
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-white shadow-sm border rounded-lg p-3 text-sm"
      >
        ✉️ Project Update: Deadline extended to next week.
      </motion.div>
      <motion.div
        variants={{ hidden: { opacity: 0 }, show: { opacity: 1 } }}
        className="bg-white shadow-sm border rounded-lg p-3 text-sm"
      >
        ✉️ Meeting tomorrow at 10am.
      </motion.div>
    </motion.div>
  );
}
